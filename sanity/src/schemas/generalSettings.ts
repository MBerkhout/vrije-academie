    ...
    defineField({
      ...
      fields: [
        ...
        defineField({
          ...
          type: "object",
          fields: [
            defineField({ name: "heading", type: "string", title: "Heading", initialValue: "Inloggen of doorgaan als gast" }),
        ...
        defineField({
          ...
          fields: [
            ...
            defineField({ name: "forgotPasswordLabel", type: "string", title: "Wachtwoord vergeten", initialValue: "Wachtwoord vergeten?" }),
            defineField({ name: "guestContinueLabel", type: "string", title: "Doorgaan als gast", initialValue: "Doorgaan als gast" }),
            defineField({ name: "backLabel", type: "string", title: "Terug knop", initialValue: "Terug" }),
          ],
        }),
        defineField({
          name: "unknownEmail",
          title: "Stap 2c — Onbekend e-mailadres (gast/nieuw)",
          type: "object",
          fields: [
            ...
            defineField({ name: "createAccountLabel", type: "string", title: "Account aanmaken checkbox", initialValue: "Account aanmaken (optioneel)" }),
            defineField({ name: "passwordLabel", type: "string", title: "Wachtwoord label", initialValue: "Wachtwoord" }),
            defineField({ name: "confirmPasswordLabel", type: "string", title: "Wachtwoord bevestigen label", initialValue: "Wachtwoord bevestigen" }),
