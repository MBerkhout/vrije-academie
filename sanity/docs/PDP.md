...
| Field | Effect |
|---|---|
| **Physical sessions heading** (`physicalSessionsHeading`) | Sessions table heading on the PDP. Default: **Data en locaties**. |
