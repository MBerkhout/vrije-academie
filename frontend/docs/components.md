...
Two tabbed listing routes share the same filter model and components under `@/components/plp`. Salesforce **Zichtbaar op Website** unchecked products are not listed (Medusa `draft`; PDP 404s).
