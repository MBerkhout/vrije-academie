    ...
    <section className="py-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {products.map((product) => {
          ...
          return (
            <article key={product._id} className="group rounded-none border border-va-lightgray overflow-hidden flex flex-col bg-white hover:shadow-md transition-shadow">
              <Link href={href} className="relative block aspect-[4/3] bg-va-lightgray overflow-hidden">
