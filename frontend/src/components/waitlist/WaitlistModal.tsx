...
export function WaitlistModal({ open, onClose, handle, title, variantId }: WaitlistModalProps) {
  ...
  useEffect(() => {
    if (!open) return
    trackViewWaitlistForm(handle, title)
  }, [open, handle, title])
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setBusy(true)
    try {
      await commerceClient.joinWaitlist(handle, {
